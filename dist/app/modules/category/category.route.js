...
router.patch("/:id", (0, auth_1.default)(user_constant_1.USER_ROLE.admin), (0, validateRequest_1.default)(category_validation_1.default.createCategoryValidation), category_controller_1.categoryController.updateCategory);
