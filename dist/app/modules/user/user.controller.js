...
const insertuserIntoDb = (0, catchAsync_1.default)((req, res) =>
...
const insertVendorIntoDb = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    req.body.role = "vendor";
    const result = yield user_service_1.userServices.insertVendorIntoDb(
      req.body
    );
    (0, sendResponse_1.default)(res, {
      statusCode: 200,
...
const updateProfile = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_service_1.userServices.updateProfile(
      req.user.userId,
      req.body
    );
    (0, sendResponse_1.default)(res, {
...
const getsingleUser = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_service_1.userServices.getSingleUser(
      req.params.id
    );
    (0, sendResponse_1.default)(res, {
      statusCode: 200,
...
const updateUser = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(req.body);
    const result = yield user_service_1.userServices.updateUser(
      req.params.id,
      req.body
    );
    (0, sendResponse_1.default)(res, {
...
const deleteAccount = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_service_1.userServices.deleteAccount(
      (_a = req === null || req === void 0 ? void 0 : req.user) === null ||
        _a === void 0
        ? void 0
        : _a.userId,
      (_b = req === null || req === void 0 ? void 0 : req.body) === null ||
        _b === void 0
        ? void 0
        : _b.password
    );
