...
const login = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.User.isUserExist(
    ...
    if (
      (user === null || user === void 0 ? void 0 : user.status) === "blocked"
    ) {
      throw new AppError_1.default(
    ...
    if (
      (user === null || user === void 0 ? void 0 : user.status) === "pending"
    ) {
      throw new AppError_1.default(
...
const changePassword = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      !(yield user_model_1.User.isPasswordMatched(
        payload === null || payload === void 0 ? void 0 : payload.oldPassword,
        user.password
      ))
    ) {
      throw new AppError_1.default(
...
const resetPassword = (token, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    let decode;
    try {
      decode = jsonwebtoken_1.default.verify(
        token,
        config_1.default.jwt_access_secret
      );
    } catch (err) {
    ...
    const user = yield user_model_1.User.findById(
      decode === null || decode === void 0 ? void 0 : decode.id
    ).select("isDeleted verification");
    if (!user) {
      throw new AppError_1.default(
        http_status_1.default.NOT_FOUND,
        "user not found"
    ...
    if (
      new Date() >
      ((_a = user === null || user === void 0 ? void 0 : user.verification) ===
        null || _a === void 0
        ? void 0
        : _a.expiresAt)
    ) {
    ...
    if (
      !((_b = user === null || user === void 0 ? void 0 : user.verification) ===
        null || _b === void 0
        ? void 0
        : _b.status)
    ) {
...
const refreshToken = (token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log("hitted");
    const decoded = (0, auth_utils_1.verifyToken)(
      token,
      config_1.default.jwt_refresh_secret
    );
