...
const getAllTopRestaurantForTable = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield TopRestaurant_service_1.topRestaurantServices.getAllTopRestaurantForTable(req.query);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: "Restaurants retrieved successfully",
